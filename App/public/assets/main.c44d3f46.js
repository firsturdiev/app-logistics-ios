/* empty css                */const p = function polyfill() {
...
const AppLauncher = registerPlugin("AppLauncher", {
  web: () => __vitePreload(() => import("./web.08cdd578.js"), true ? ["assets/web.08cdd578.js","assets/style.847bf02d.css"] : void 0).then((m) => new m.AppLauncherWeb())
});
(async function() {
